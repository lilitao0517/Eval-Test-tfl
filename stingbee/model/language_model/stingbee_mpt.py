...
from stingbee.model.stingbee_arch import StingBeeMetaModel, StingBeeMetaForCausalLM


class StingBeeMPTConfig(MPTConfig):
    model_type = "stingbee_mpt"


class StingBeeMPTModel(StingBeeMetaModel, MPTModel):
    config_class = StingBeeMPTConfig

    def __init__(self, config: MPTConfig):
        config.hidden_size = config.d_model
        super(StingBeeMPTModel, self).__init__(config)
    
    def embed_tokens(self, x):
        return self.wte(x)


class StingBeeMPTForCausalLM(MPTForCausalLM, StingBeeMetaForCausalLM):
    config_class = StingBeeMPTConfig
    ...
    def __init__(self, config):
        ...
        self.transformer = StingBeeMPTModel(config)
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, StingBeeMPTModel):
...
AutoConfig.register("stingbee_mpt", StingBeeMPTConfig)
AutoModelForCausalLM.register(StingBeeMPTConfig, StingBeeMPTForCausalLM)
